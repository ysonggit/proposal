...
\begin{figure}
  \begin{tikzpicture}[scale=0.5]
    ...
    \draw[fill=red] (3,4.5) circle (0.2);
    \draw[fill=red] (3.2,1.7) circle (0.2);
    \draw[fill=red] (1,3) circle (0.2);
    \draw[fill=red] (2,0.5) circle (0.2);
    \draw[fill=red] (4,3.3) circle (0.2);
    \draw[fill=red] (4.4,4.8) circle (0.2);
  \end{tikzpicture}
...
%   environments, and 3 range spaces $\mathcal{R}_{disk}$, $\mathcal{R}_{rect}$,
%   and  $\mathcal{R}_{drect}$. \\
%   \includemovie[toolbar,poster,autoplay]{7cm}{3cm}{videos/clutter_dbrect.mp4}
% \end{frame}  
\begin{frame}{Simulation}{Navigation in $\mathcal{R}_{dbrect}$}
  \begin{center}
    \includemovie[toolbar,poster,autoplay]{7cm}{5cm}{videos/clutterdbrect.mp4}
  \end{center}
=======
\begin{frame}{Experiments}{Experiments in Various Environments}
  \begin{center}
    \includemovie[toolbar,poster,autoplay]{7cm}{5cm}{videos/dbrect.mp4}
  \end{center}
\end{frame} 
...
\begin{frame}{Comparison of Efficiency and Accuracy}{Office-like Environment}
\begin{columns}
  ...
  \begin{column}{.45\textwidth}
    \begin{figure}
      \includegraphics[scale=0.2]{figs/tab1.jpg}
      \caption{Comparison of the computation time and approximation ratio for
        approximated I-states to the corresponding measurements of the exact
        I-states.}
    \end{figure}
  \end{column}
\end{columns}
...
%   \begin{figure}
%     \includegraphics[scale=0.25]{figs/rate-office.jpg}
...
\begin{frame}{Conclusions}
  ...
  \end{itemize}
>>>>>>> 6d3e49992ef39f51941f24c22c8dc8a9f12fc041
\end{frame}
...
\begin{frame}{Simulation}{Octagon-square formation with 30 robots}
  \begin{center}
    \includemovie[toolbar,poster,autoplay]{7cm}{7cm}{videos/octsq.mp4}
  \end{center}
\end{frame}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{frame}{Simulation}{Triangle-Hexagon-Square formation with 30 robots}
  \begin{center}
    \includemovie[toolbar,poster,autoplay]{7cm}{7cm}{videos/trihexsq.mp4}
  \end{center}
\end{frame}
%%%%%%%%%%%%%%%%
