...
\begin{frame}{Example Application}{Rectangle Approximation}
 \begin{textblock*}{\paperwidth}(0px,0px)
    \movie[width=\paperwidth,height=0.96\paperheight,poster]{}{videos/clutter_rect.avi} 
    % NOTE: because of the way poppler works, we use "poster" to indicate that the movie should loop!
  \end{textblock*}
  %\begin{center}
  %\href{run:/usr/local/bin/mplayer -fs videos/rect.mp4}{
  %  \includegraphics[scale=0.25]{figs/clutter.jpg}}
  %  \includemovie[toolbar,poster,autoplay]{\paperwidth}{}{videos/clutter_rect.mp4}
  %\end{center}
\end{frame}
...
% \subsubsection[Rectangle Range Space]{Rectangle Range Space}
% \begin{frame}{Observation Update in $\mathcal{R}_{rect}$}
%   \begin{definition}{\textbf{$AABB(S)$} :}
...
\begin{frame}{Experiments}{Double-Rectangle Approximation}
  \begin{center}
    %\includemovie[toolbar,poster,autoplay]{\paperwidth}{}{videos/clutter_dbrect.mp4}
  \end{center}
\end{frame} 
...
\begin{frame}{Comparison of Success Rate}{Obstacle-free Environment}
\begin{figure}
