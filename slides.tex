...
\begin{frame}{Objectives}{3. Algorithm Optimization}
  \textbf{Problems:}
  \begin{enumerate}
  \item Chain effects: when a parent robot rotates, all of its descendant robots
    rotate
  \item 
  \end{enumerate}
...
\begin{frame}{Conclusions}
  We proposed a novel distributed algorithm for the multi-robot formation
  problem. 
  \begin{itemize}
  \item Develop the theory to apply our algorithm 
  \item Prove the correctness of our algorithm 
  \item Improve the performance of our algorithm
  \end{itemize}
