...
\begin{frame}{Information Space}
  % \colorbox{scred!40}{\parbox{0.95\textwidth}{
  %     Objective: form a plan $\pi$ for the robot to execute using the information
  %     available in the information space.
  %   }}
  \begin{definition}
...
\begin{frame}{Simulations}
  \begin{columns}
    ...
    \begin{column}{.45\textwidth}
       \begin{center}
         \includemovie[toolbar,poster,autoplay]{5cm}{5cm}{videos/hexsq.mp4}
       \end{center}
        % \begin{figure}
